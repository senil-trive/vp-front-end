          ...
          <Grid container>
            ...
            <Grid item xs={12} md={8} lg={6}>
              ...
              <div style={{ display: "flex", gap: 32 }}>
                <Button href="/kinderen/forum/stel-een-vraag" style={{ backgroundColor: "#3FC7B4", fontSize: "18px", fontWeight: "300"  }}>
                  {pageData?.submit_question_button_label}
                </Button>
                <Button
                  variant="white"
                  filled={false}
                  href="/kinderen/klets-met-een-buddy"  style={{ fontSize: "18px", fontWeight: "300", border: "1px solid #fff"  }}
                >
